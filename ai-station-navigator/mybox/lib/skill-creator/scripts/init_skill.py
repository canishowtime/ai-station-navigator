...
Usage:
    init_skill.py <skill-name> --path <output-dir>
Examples:
    init_skill.py my-new-skill --path ../../skills/custom
    init_skill.py data-analyzer --path ../../skills/custom
"""
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nExamples:")
        print(" init_skill.py my-new-skill --path ../../skills/custom")
        print(" init_skill.py data-analyzer --path ../../skills/custom")
        sys.exit(1)

    skill_name = sys.argv[1]
    path = sys.argv[3]

    print(f"[INIT] Creating skill: {skill_name}")
