...
**AI Station Navigator** 是一款基于 Claude Code 引擎构建的模块化 AI 工作站。它模仿计算机组成原理，将繁杂的 AI 任务精准路由至隔离的子智能体（Sub-Agents）执行。项目集成了沙盒化执行环境与“应用商店式”技能管理，配合全绿色的免安装运行环境，旨在为开发者提供一个“解压即用”、性能恒定、无限扩展的个人 AI 智慧中枢。
